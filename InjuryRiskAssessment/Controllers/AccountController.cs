...
using InjuryRiskAssessment.Models;
...
using InjuryRiskAssessment.Views.SaasEcom.ViewModels;
using InjuryRiskAssessment.Extensions;
using SaasEcom.Core.Infrastructure.Helpers;
using SaasEcom.Core.Models;

namespace InjuryRiskAssessment.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var countery = GeoLocationHelper.GetCountryFromIP(userIP);
                if (string.IsNullOrEmpty(countery))
                {
                    countery = "BD";
                }
